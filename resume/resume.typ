...
AI Application Engineer focused on *Information Retrieval* and *scalable backend systems* — production-grade vector search, Agentic RAG, latency optimization. Strong fast-prototyping track record with *Prefect, Kubernetes, GitOps* and high-availability *FastAPI* services.
...
#linebreak()
#skill("Retrieval & Vector DBs", ("Qdrant", "Hybrid search", "Sparse/Dense embeddings"))
#linebreak()
#skill("ML / Inference", ("PyTorch", "LangChain", "Transformers", "NVIDIA Triton", "OpenVINO", "ONNX Runtime", "Quantization", "MLflow"))
#linebreak()
#skill("Backend & App", ("FastAPI", "BentoML", "Redis", "PostgreSQL", "Streamlit", "React"))
#linebreak()
